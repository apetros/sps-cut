...
{{< figure src="Synchrophasor.png" title="Synchrophasor wide-area monitoring and detection framework" >}}
...
{{< figure src="mPMU-schem.jpg" title="Simplified Phasor Measurement Unit block diagram" >}}
...
{{< figure src="mPMU-mini2.jpg" title="Concept of miniaturised µPMU" >}}
